// ==UserScript==
// @name         Activate Star Card 2023
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  激活星梦卡2023
// @author       You
// @match        *://www.ckg48.com/event/s321/star/activate.html
// @match        *://ckg48.com/event/s321/star/activate.html
...
(function() {
    ...
    $('#card-numbers').after("<div id='confirm-card-count'>已读取星梦卡 <span id='card-count' style='color: aqua; font-weight:bold'>0</span> 张 | 已提交 <span id='completed-card-count' style='color: lime; font-weight:bold'>0</span> 张</div>");
